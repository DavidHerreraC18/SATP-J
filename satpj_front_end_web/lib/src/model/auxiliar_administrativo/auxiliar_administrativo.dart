...
List<AuxiliarAdministrativo> auxiliarAdministrativoFromJson(String str) =>
    List<AuxiliarAdministrativo>.from(json.decode(str).map((x) => AuxiliarAdministrativo.fromJson(x)));
...
class AuxiliarAdministrativo extends Usuario{
  ...
  factory AuxiliarAdministrativo.fromJson(Map<String, dynamic> json) =>  _$AuxiliarAdministrativoFromJson(json);

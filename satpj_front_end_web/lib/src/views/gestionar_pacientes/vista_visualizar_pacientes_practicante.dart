...
class VistaVisualizarPacientesPracticante extends StatelessWidget {
  static const route = '/visualizar-pacientes-practicante';

  const VistaVisualizarPacientesPracticante({Key key}) : super(key: key);
        ...
        children: [
          Expanded(
            child: ChangeNotifierProvider<PacienteNotifier>(
              create: (_) => PacienteNotifier(3, uid: uid),

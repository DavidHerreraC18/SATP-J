...
class VistaLlamadaPracticante extends StatefulWidget {
  static const route = '/videollamada-practicante';
  @override
  _MeetingState createState() => _MeetingState();
}

class _MeetingState extends State<VistaLlamadaPracticante> {
  ...
  final youtubeLinkText = TextEditingController(text: null);

...
const _path = "/acudientes";

class ProviderAcudientes {
  
  static Future<String> crearAcudiente(Acudiente acudienteNuevo) async {
    Map<String, dynamic> acudiente = acudienteNuevo.toJson();
    ...
    try {
      ...
      final resp = await http.post(Uri.http(ApiDefinition.url, _path),
          headers: ApiDefinition.header, body: acudiente);

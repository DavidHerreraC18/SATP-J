...
class FormSupervisorInformation extends StatefulWidget {
  ...
  FormSupervisorInformation({this.supervisor, this.prefix = 'el',
    this.label = 'del supervisor', this.enabled = true, 
  });
...
class _FormState extends State<FormSupervisorInformation> {
  ...
  @override
  void initState() {
    textControllerEnfoque = new TextEditingController(text: widget.supervisor.enfoque);

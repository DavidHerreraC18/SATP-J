...
class _FormState extends State<FormInternInformation> {
  ...
  @override
  void initState() {
    textControllerPregrado = TextEditingController(
        text: widget.practicante.pregrado != null
            ? widget.practicante.pregrado.toString()
            : null);
    textControllerSemestre = TextEditingController(
        text: widget.practicante.semestre != null
            ? widget.practicante.semestre.toString()
            : null);
    textControllerEnfoque =
        TextEditingController(text: widget.practicante.enfoque);

    textFocusNodePregrado = FocusNode();
    textFocusNodeSemestre = FocusNode();
    textFocusNodeEnfoque = FocusNode();

    if (widget.practicante.pregrado != null) {
      pregrado = widget.practicante.pregrado;
      posgrado = !widget.practicante.pregrado;
    }
                    ...
                    RoundedTextFieldValidators(
                        ...
                        validate: () {
                          if (textControllerSemestre.text.isNotEmpty)
                            widget.practicante.semestre =
                                int.parse(textControllerSemestre.text);

...
public class ServicioNotaEvolucion {
    ...
    public List<NotaEvolucion> findAll() {
        return repositorioNotaEvolucion.findAll();
    }

    @GetMapping(value = "/{idSesion}/{idPracticante}", produces = "application/json")
    public NotaEvolucion findByLlaveNotaEvolucionId(@PathVariable("idSesion") Long idSesion,
    ...
    public List<NotaEvolucion> findAllNotasBySupervisor(@PathVariable("idSupervisor") Long idSupervisor) {
        Supervisor supervisor = servicioSupervisor.findById(idSupervisor);
    ...
    public List<NotaEvolucion> findAllNotasBySupervisorRegistradas(@PathVariable("idSupervisor") Long idSupervisor) {
        Supervisor supervisor = servicioSupervisor.findById(idSupervisor);
        Preconditions.checkNotNull(supervisor);
        List<NotaEvolucion> notasEvolucion = repositorioNotaEvolucion.findBySupervisor(supervisor);
    ...
    public List<NotaEvolucion> findAllNotasBySupervisorNoRegistradas(@PathVariable("idSupervisor") Long idSupervisor) {
        Supervisor supervisor = servicioSupervisor.findById(idSupervisor);
        Preconditions.checkNotNull(supervisor);
        List<NotaEvolucion> notasEvolucion = repositorioNotaEvolucion.findBySupervisor(supervisor);
        List<NotaEvolucion> notasRegistradas = new ArrayList<>();
    ...
    public NotaEvolucion findBySesionTerapiaId(@PathVariable("id") Long id) {
        return repositorioNotaEvolucion.findByPracticanteId(id, Pageable.unpaged()).get().findFirst().get();
    }

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public NotaEvolucion create(@RequestBody NotaEvolucion notaEvolucion) {
    ...
    public void update(@PathVariable("id") Long id, @RequestBody NotaEvolucion notaEvolucion) {
        Preconditions.checkNotNull(notaEvolucion);
    ...
    @ResponseStatus(HttpStatus.OK)
    public void delete(@PathVariable("id") Long id, @RequestBody NotaEvolucion notaEvolucion) {

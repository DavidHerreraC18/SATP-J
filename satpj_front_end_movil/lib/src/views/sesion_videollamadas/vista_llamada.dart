...
import 'package:satpj_front_end_movil/src/providers/provider_administracion_pacientes.dart';
import 'package:satpj_front_end_movil/src/providers/provider_administracion_practicantes.dart';
...
class VistaLlamada extends StatefulWidget {
  static const route = '/videollamada';
  @override
  _MeetingState createState() => _MeetingState();
}

class _MeetingState extends State<VistaLlamada> {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.hasError)
            ...
            return Scaffold(
              ...
              drawer: drawerPaciente(context, usuarioActual),
              body: Container(

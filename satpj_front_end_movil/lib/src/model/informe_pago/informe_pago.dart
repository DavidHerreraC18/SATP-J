...
List<InformePago> informePagoFromJson(String str) => List<InformePago>.from(
    json.decode(str).map((x) => InformePago.fromJson(x)));
...
class InformePago {
  ...
  InformePago(
      {this.id, this.comprobante, this.fechaInicio, this.fechaFin, this.total});

  factory InformePago.fromJson(Map<String, dynamic> json) =>
      _$InformePagoFromJson(json);

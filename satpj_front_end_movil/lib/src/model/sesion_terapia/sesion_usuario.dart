...
import 'package:satpj_front_end_movil/src/model/sesion_terapia/llave_sesion_usuario.dart';
...
class SesionUsuario {
  ...
  SesionUsuario({this.id, this.usuario, this.sesionTerapia, this.observador});

  factory SesionUsuario.fromJson(Map<String, dynamic> json) =>
      _$SesionUsuarioFromJson(json);

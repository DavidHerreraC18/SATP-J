...
List<DocumentoPaciente> documentoPacienteFromJson(String str) =>
    List<DocumentoPaciente>.from(
        json.decode(str).map((x) => DocumentoPaciente.fromJson(x)));
...
class DocumentoPaciente {
  ...
  factory DocumentoPaciente.fromJson(Map<String, dynamic> json) =>
      _$DocumentoPacienteFromJson(json);
